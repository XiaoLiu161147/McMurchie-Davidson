...
class PostSCF(object):
    ...
    def CCSD(self):
       ...
       # # testing
       #                 SOMP2 += 0.25*spinints[i,j,a,b]*td[a,b,i,j]
       # print('EMP2(SO): ', SOMP2.real+self.mol.energy)
       # print('EMP2(corr): ', SOMP2.real)
       # assert SOMP2.real+self.mol.energy == self.mol.emp2
